            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex flex-wrap justify-start gap-4 w-full">
                <a href="https://pkcardrummy.com/?from_gameid=5784509&channelCode=100000" 
                   className="inline-flex items-center justify-center px-6 py-3 md:px-10 md:py-4 bg-[#fbbf24] text-[#0f172a] font-bold rounded-lg hover:bg-opacity-90 transition-all shadow-lg text-base md:text-xl animate-pulse hover:animate-none">
                  <FiDownload className="mr-2 md:mr-3" size={18} />
                  Download Card Rummy
                </a>
                <div className="text-xs text-gray-300 mt-2 italic">*Available for Android devices only</div>
              </div>
            </div>
          </div>
