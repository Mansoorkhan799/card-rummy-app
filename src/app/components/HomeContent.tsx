import { FiCheck, FiDownload, FiUser, FiDollarSign, FiGift, FiZap, FiLock, FiSmartphone, FiAward, FiHelpCircle, FiEye, FiStar, FiHeadphones, FiShield, FiAward as FiTrophy, FiCreditCard, FiSmile, FiHeart, FiInfo, FiRefreshCw } from 'react-icons/fi';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="mt-6 mb-8 flex justify-center">
              <a
                ...
                className="inline-flex items-center justify-center bg-[#fbbf24] text-[#0f172a] px-8 py-3 rounded-lg hover:bg-[#fbbf24]/90 transition-colors text-lg font-bold"
              >
                <FiDownload className="mr-2" size={18} />
                <span>Download Card Rummy APK</span>
              </a>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#132044] p-4 rounded-lg text-center font-bold text-xl">
              <a href="https://pkcardrummy.com/?from_gameid=5784509&channelCode=100000" className="text-[#fbbf24] hover:underline">
                👉 Download Card Rummy APK now and start winning!
              </a>
            </div>
          </div>
